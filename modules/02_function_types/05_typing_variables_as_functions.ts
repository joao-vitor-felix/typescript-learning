...
// When you're defining a variable as a function type, you do it with the arrow function syntax.

function sumWithCallback(a: number, b: number, cb: (sum: number) => void) {
  cb(a+b)
}

// When you're defining something as a function type, you do it with the arrow function syntax.

...
// We can also use React.FC to define the type of the component, but it adds some extra properties to the component which are not necessary most of the time.
